...
description: |-
  ...
  A social game played in person, seated in a circle, each player receives either a ‘good’ or ‘evil’ token with their unique character on it.
events:
  recurring:
  - eventname: Reading Biscuit Factory
    ...
    event_id: reading-biscuit-factory
---
