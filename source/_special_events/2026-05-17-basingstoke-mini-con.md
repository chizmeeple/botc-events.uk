---
name: Blood at the DiceTower Mini Con!
...
clocktracker: ''
description: |-
  This will be a limited ticket event aiming to keep towns at around 12 per
  group where we can.

  £22 covers entry and also gives you a meal voucher to use at any time
  throughout the day until the bar closes in the evening.
events:
  special:
